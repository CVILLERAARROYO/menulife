        ...
        <nav class="navbar navbar-default navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a id="nav-li" class="navbar-brand" href="<?php echo e(url('/')); ?>">
                    ...
                    <ul class="nav navbar-nav navbar-right" >
                        <!-- Authentication Links -->
                          <?php if(auth()->guard()->guest()): ?>
                            <li ><a id="nav-li"  href="<?php echo e(route('login')); ?>"><strong>INICIAR SESIÓN</strong></a></li>
                            <li><a id="nav-li" href="<?php echo e(route('register')); ?>"><strong>REGISTRARSE</strong></a></li>
                        <?php else: ?>
                            <li id="li-name" class="dropdown">
                                <a id="li-name" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                                   <strong> <?php echo e(Auth::user()->name); ?> <span class="caret"></span></strong>
                                </a>

                                <ul id="li-nav" class="dropdown-menu" role="menu">
                                    <li id="li-nav">
                                        <a id="li-nav" href="<?php echo e(route('logout')); ?>"
